  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="rounded-3xl overflow-hidden mb-8 shadow-lg">
        ...
        >
          <p className="text-[#F0C505] text-xs font-bold tracking-widest uppercase mb-2">
      ...
      <form onSubmit={handleSubmit} className="space-y-10">
        ...
        <section className="bg-white p-6 sm:p-8 rounded-2xl border border-gray-100 shadow-sm">
          <h2 className="text-lg font-black text-[#0C1B33] mb-4 pb-2 border-b border-orange-100 flex items-center gap-2">
            📋 Admission Details
          </h2>
        ...
        <section className="bg-white p-6 sm:p-8 rounded-2xl border border-gray-100 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-black text-[#0C1B33] pb-2 border-b border-orange-100">
        ...
        <div className="text-center pt-6">
          <button
            type="submit"
            className="px-10 py-4 text-white text-base font-black rounded-2xl shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-200"
            style={{
